<?php 
    ...
    require('Control/Settings/NewTeacherAction.php'); 
    ...
    <div class="d-flex" id="wrapper">
        ...
        ?>
                <form class="row g-3 needs-validation" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-7">
                        <label for="validationCustomUsername" class="form-label">Course</label>
                        <div class="input-group has-validation">
                        <input type="text" name="course" class="form-control" placeholder="Php, Droit, Computer science" >
                        </div>
                    </div>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-9">
                        <label for="validationCustom05" class="form-label">Pictute Teacher</label>
                        <input type="file" name="profil" class="form-control">
                    </div>
                    <div class="d-grid gap-2 col-6 mx-auto mt-5">
                        <button class="btn btn-success" name="add" type="submit">New Teacher</button>
                    </div>
                </form>
            </div>
