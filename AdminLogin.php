<?php 
  require('Control/Settings/LoginAction.php'); 
?>
<!doctype html>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" method="post">
          <div class="row g-3">
            <div class="col-sm-12">
              <label for="firstName" class="form-label">Your Username</label>
              <input type="text" class="form-control" name="pseudo" placeholder="@etando school" >
            </div>
            <div class="col-sm-12">
              <label for="firstName" class="form-label">Your Password</label>
              <input type="password" class="form-control" name="mdp"  placeholder="xxxxx" >
          ...
          <button class="w-100 btn btn-success btn-lg" name="connexion" type="submit">Connexion</button>
        </form>
      </div>
    </div>
  </main>
