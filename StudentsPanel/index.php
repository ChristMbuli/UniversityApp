...
<div class="container py-3">
  <header>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
      <h1 class="display-4 fw-normal text-body-emphasis">My Courses</h1>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          <div class="card-header py-3">
            <h4 class="my-0 fw-normal"><?= $row['name_course'] ?></h4>
          </div>
          <div class="card-body">
          <img class=" me-3" src="../<?= $row['images_course'] ?>" alt="" width="330" height="190">
            <ul class="list-unstyled mt-3 mb-4">
              <li>Teacher : <small class="text-success"><?= $row['name_teacher'] ?></small></li>
            </ul>
            <a href="allcourse.php?id=<?= $row['id_course']?>" class="w-100 btn btn-lg btn-outline-success">See course</a>
          </div>
        </div>
      </div>
<?php } ?>
