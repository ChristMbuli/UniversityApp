<?php 
  require('Panel/LoginStudentAction.php');
    ...
    <div class="row g-5">
      <div class="col-md-5 col-lg-4 order-md-last">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          <span class="text-success">Notifications</span>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" method="post">
          ...
          <div class="col-md-12">
            ...
            <div class="col-sm-12">
              <label for="firstName" class="form-label">Your Matricule</label>
              <input type="text" class="form-control" name="matricule" placeholder="@etando school" >
            </div>
          <hr class="my-4">
